...
foreign android {
	 ...
	 */
	AImageDecoder_resultToString :: proc(result: AImageDecoderResult) -> cstring ---
	...
	*   supported.
	*/
	AImageDecoder_createFromAAsset :: proc(asset: ^AAsset, outDecoder: ^^AImageDecoder) -> AImageDecoderResult ---
	...
	*   supported.
	*/
	AImageDecoder_createFromFd :: proc(fd: i32, outDecoder: ^^AImageDecoder) -> AImageDecoderResult ---
	...
	*   supported.
	*/
	AImageDecoder_createFromBuffer :: proc(buffer: rawptr, length: uint, outDecoder: ^^AImageDecoder) -> AImageDecoderResult ---
	...
	* Available since API level 30.
	*/
	AImageDecoder_delete :: proc(decoder: ^AImageDecoder) ---
	...
	*   the first frame.
	*/
	AImageDecoder_setAndroidBitmapFormat :: proc(decoder: ^AImageDecoder, format: AndroidBitmapFormat) -> AImageDecoderResult ---
	...
	*   the first frame.
	*/
	AImageDecoder_setUnpremultipliedRequired :: proc(decoder: ^AImageDecoder, unpremultipliedRequired: bool) -> AImageDecoderResult ---
	...
	*   the first frame.
	*/
	AImageDecoder_setDataSpace :: proc(decoder: ^AImageDecoder, dataspace: ADataSpace) -> AImageDecoderResult ---
	...
	*   the first frame.
	*/
	AImageDecoder_setTargetSize :: proc(decoder: ^AImageDecoder, width: i32, height: i32) -> AImageDecoderResult ---
	...
	*/
	AImageDecoder_computeSampledSize :: proc(decoder: ^AImageDecoder, sampleSize: i32, width: ^i32, height: ^i32) -> AImageDecoderResult ---
	...
	*   the first frame.
	*/
	AImageDecoder_setCrop :: proc(decoder: ^AImageDecoder, crop: ARect) -> AImageDecoderResult ---
	...
	* Available since API level 30.
	*/
	AImageDecoder_getHeaderInfo :: proc(decoder: ^AImageDecoder) -> ^AImageDecoderHeaderInfo ---
	...
	* Available since API level 30.
	*/
	AImageDecoderHeaderInfo_getWidth :: proc(header_info: ^AImageDecoderHeaderInfo) -> i32 ---
	...
	* Available since API level 30.
	*/
	AImageDecoderHeaderInfo_getHeight :: proc(header_info: ^AImageDecoderHeaderInfo) -> i32 ---
	...
	*/
	AImageDecoderHeaderInfo_getMimeType :: proc(header_info: ^AImageDecoderHeaderInfo) -> cstring ---
	...
	* Available since API level 30.
	*/
	AImageDecoderHeaderInfo_getAndroidBitmapFormat :: proc(header_info: ^AImageDecoderHeaderInfo) -> AndroidBitmapFormat ---
	...
	* alpha.
	*/
	AImageDecoderHeaderInfo_getAlphaFlags :: proc(header_info: ^AImageDecoderHeaderInfo) -> AndroidBitmapFlagsAlpha ---
	...
	*/
	AImageDecoderHeaderInfo_getDataSpace :: proc(header_info: ^AImageDecoderHeaderInfo) -> ADataSpace ---
	...
	* Available since API level 30.
	*/
	AImageDecoder_getMinimumStride :: proc(decoder: ^AImageDecoder) -> uint ---
	...
	*/
	AImageDecoder_decodeImage :: proc(decoder: ^AImageDecoder, pixels: rawptr, stride: uint, size: uint) -> AImageDecoderResult ---
	...
	*/
	AImageDecoder_isAnimated :: proc(decoder: ^AImageDecoder) -> bool ---
	...
	*   before calling {@link AImageDecoder_decodeImage} again.
	*/
	AImageDecoder_advanceFrame :: proc(decoder: ^AImageDecoder) -> AImageDecoderResult ---
	...
	*/
	AImageDecoder_rewind :: proc(decoder: ^AImageDecoder) -> AImageDecoderResult ---
	...
	*/
	AImageDecoderFrameInfo_create :: proc() -> ^AImageDecoderFrameInfo ---
	...
	* Introduced in API 31.
	*/
	AImageDecoderFrameInfo_delete :: proc(info: ^AImageDecoderFrameInfo) ---
	...
	*/
	AImageDecoder_getFrameInfo :: proc(decoder: ^AImageDecoder, info: ^AImageDecoderFrameInfo) -> AImageDecoderResult ---
	...
	*/
	AImageDecoderFrameInfo_getFrameRect :: proc(info: ^AImageDecoderFrameInfo) -> ARect ---
	...
	*/
	AImageDecoderFrameInfo_hasAlphaWithinBounds :: proc(info: ^AImageDecoderFrameInfo) -> bool ---
	...
	*               frames.
	*/
	AImageDecoder_setInternallyHandleDisposePrevious :: proc(decoder: ^AImageDecoder, handleInternally: bool) ---
}
