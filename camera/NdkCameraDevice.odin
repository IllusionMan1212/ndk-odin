...
ErrorStateCallbackError :: enum i32 {
    /**
...
*/
ACameraDevice_request_template :: enum {
	/**
 ...
 */
ACameraIdList :: struct {
	numCameras: i32,          ///< Number of camera device Ids
    cameraIds: [^]cstring,  ///< list of camera device Ids
}
 ...
 */
ACameraDevice_StateCallbacks :: struct {
     ...
     *
     */
    onDisconnected: ACameraDevice_StateCallback,
     ...
     *
     */
    onError: ACameraDevice_ErrorStateCallback,
}
...
*/
ACaptureSessionOutputContainer :: struct{}
 ...
 */
ACameraDevice_StateCallback :: #type proc "c" (_context: rawptr, device: ^ACameraDevice)
 ...
 */
ACameraDevice_ErrorStateCallback :: #type proc "c" (_context: rawptr, device: ^ACameraDevice, error: ErrorStateCallbackError)
...
foreign camerandk {
	 ...
	 */
	ACameraDevice_close :: proc(device: ^ACameraDevice) -> CameraStatus ---
	...
	* has been closed.
	*/
	ACameraDevice_getId :: proc(device: ^ACameraDevice) -> cstring ---
	...
	* @see TEMPLATE_MANUAL
	*/
	ACameraDevice_createCaptureRequest :: proc(device: ^ACameraDevice, templateId: ACameraDevice_request_template, request: ^^ACaptureRequest) -> CameraStatus ---
	...
	*/
	ACaptureSessionOutputContainer_create :: proc(container: ^^ACaptureSessionOutputContainer) -> CameraStatus ---
	...
	*/
	ACaptureSessionOutputContainer_free :: proc(container: ^ACaptureSessionOutputContainer) ---
	...
	*/
	ACaptureSessionOutput_create :: proc(anw: ^ACameraWindowType, output: ^^ACaptureSessionOutput) -> CameraStatus ---
	...
	*/
	ACaptureSessionOutput_free :: proc(output: ^ACaptureSessionOutput) ---
	...
	*/
	ACaptureSessionOutputContainer_add :: proc(container: ^ACaptureSessionOutputContainer, output: ^ACaptureSessionOutput) -> CameraStatus ---
	...
	*         <li>{@link ACAMERA_ERROR_INVALID_PARAMETER} if container or output is NULL.</li></ul>
	*/
	ACaptureSessionOutputContainer_remove :: proc(container: ^ACaptureSessionOutputContainer, output: ^ACaptureSessionOutput) -> CameraStatus ---
	...
	*         <li>{@link ACAMERA_ERROR_UNKNOWN} if the method fails for some other reasons.</li></ul>
	*/
	ACameraDevice_createCaptureSession :: proc(device: ^ACameraDevice, outputs: [^]ACaptureSessionOutputContainer, callbacks: [^]ACameraCaptureSession_stateCallbacks, session: ^^ACameraCaptureSession) -> CameraStatus ---
	...
	* @see ACaptureSessionOutputContainer_add
	*/
	ACaptureSessionSharedOutput_create :: proc(anw: ^ACameraWindowType, output: ^^ACaptureSessionOutput) -> CameraStatus ---
	...
	*/
	ACaptureSessionSharedOutput_add :: proc(output: ^ACaptureSessionOutput, anw: ^ACameraWindowType) -> CameraStatus ---
	...
	*             ACaptureSessionOutput.</li></ul>
	*/
	ACaptureSessionSharedOutput_remove :: proc(output: ^ACaptureSessionOutput, anw: ^ACameraWindowType) -> CameraStatus ---
	...
	*         <li>{@link ACAMERA_ERROR_UNKNOWN} if the method fails for some other reasons.</li></ul>
	*/
	ACameraDevice_createCaptureSessionWithSessionParameters :: proc(device: ^ACameraDevice, outputs: [^]ACaptureSessionOutputContainer, sessionParameters: [^]ACaptureRequest, callbacks: [^]ACameraCaptureSession_stateCallbacks, session: ^^ACameraCaptureSession) -> CameraStatus ---
	...
	* @see ACaptureSessionOutputContainer_add
	*/
	ACaptureSessionPhysicalOutput_create :: proc(anw: ^ACameraWindowType, physicalId: cstring, output: ^^ACaptureSessionOutput) -> CameraStatus ---
	...
	* @see TEMPLATE_MANUAL
	*/
	ACameraDevice_createCaptureRequest_withPhysicalIds :: proc(device: ^ACameraDevice, templateId: ACameraDevice_request_template, physicalIdList: [^]ACameraIdList, request: ^^ACaptureRequest) -> CameraStatus ---
	...
	*        </ul>
	*/
	ACameraDevice_isSessionConfigurationSupported :: proc(device: ^ACameraDevice, sessionOutputContainer: ^ACaptureSessionOutputContainer) -> CameraStatus ---
}
